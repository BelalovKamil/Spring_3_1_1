...
public class DatabaseConfig {
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setTimeBetweenEvictionRunsMillis(Integer
                .parseInt(env.getProperty("db.timeBetweenEvictionRunsMillis")));
        dataSource.setMinEvictableIdleTimeMillis(Integer
                .parseInt(env.getProperty("db.minEvictableIdleTimeMillis")));
